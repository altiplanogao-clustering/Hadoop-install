...
container_name=single_debugging
...
docker run --rm -it -p 8088:8088 -p 50070:50070 -p 50075:50075 -P --hostname single_debugging --name single_debugging andy/hadoop-single:latest /run.sh -bash
